...
class AdafruitFeatherHuzzah(Board):
    ...
    def burn(self,bin,outfn=None):
        ...
        if prom_addr % 0x1000 != 0:
            ...
            #add origin
            prom_addr+=0x20000
        res,out,err = proc.runcmd("python",tools["esptool"],"--port",self.port,"write_flash","--flash_freq","40m","--flash_mode","dio","--flash_size","32m","--verify", "0x00000",romf, "0x20000", iromf, "0x3fc000",bromf,hex(prom_addr),promf,outfn=outfn)
